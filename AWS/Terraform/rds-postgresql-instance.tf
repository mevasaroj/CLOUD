...
#=================================================================================================================================================
module "postgresql-instance-01" {
  source = "terraform.hdfcbank.com/HDFCBANK/module/aws//modules/aws-rds_v6"
  identifier            = join("-", [local.org, local.csp, local.region, local.account, local.vpcname, local.env, "postgresql-instance-01"])
  ...
  tags = merge(
    {
      Name = "${join("-", [local.org, local.csp, local.region, local.account, local.vpcname, local.env, "postgresql-instance-01"])}"
    }, var.additional_tags
  )
}
