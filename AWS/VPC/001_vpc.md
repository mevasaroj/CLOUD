...
##### 1.2.1. Key Characteristics of Subnet
 ...
 - **IP Range**: Each subnet is defined by a CIDR block (e.g., 10.0.1.0/24) that must be a subset of the overall VPC CIDR block.
